...
import { VerifyOtpResponseDTO } from "../../../domain/dtos/user/VerifyOtpResponseDTO";
import { VerifyOtpDTO } from "../../../domain/dtos/user/VerifyOtpDTO";
...
const user =User.createNew(userData.id,userData.name,new Email(userData.email),new Password(userData.password),UserRole.USER)
